...
public class UserCrawlerTest  extends test{
	...
	private String GRAP_DB_PATH = CoreContext.ROOT_DATA_FOLDER + "USER_TEST_DB";
	...
	public void setUp() throws Exception 
	{
		...
		CoreContext.GRAPH_DB_DIR = GRAP_DB_PATH;
	...
	public void testCrawl()
	{
		for (String user :TESTS_USERS)
		{
			...
			assertTrue(FileServices.PathExist(PinterestContext.USERS_FOLDER_POOL_PATH + "/" +PinterestContext.AlignUserName(user) ));
