 ...
 * @version 1.0
 * 
 * The info-item holds the info-beads value as well as all the data that is relevant to a value 
 * that the info-bead holds. The data helps explaining the data
 *
 */
public class InfoItem {
	
	private String infoValueType;  // the type of the value - assisting in understanding what value is it
	private Object infoValue;	// the value itself
	 ...
	 */
	public void setInfoValue(Object info) {
		this.infoValue = info;
	}
